...
| Platform | Type | Template File | Taxonomy | Key Difference |
|:---------|:-----|:-------------|:---------|:---------------|
| **Immunefi** | Web3 | `immunefi_submission_form.md` | Impact + CVSS | Secret Gist 필수, AI 탐지 강력 |
| **HackenProof** | Web3 | `hackenproof_submission_form.md` | Severity | Web3 특화, 빠른 triage, 경쟁 적음 |
| **Hats Finance** | Web3 | `hatsfinance_submission_form.md` | Vault % | 탈중앙화, KYC 불필요, 온체인 제출 |
| **Bugcrowd** | Web2+3 | `bugcrowd_submission_form.md` | VRT (P1-P5) | 제출 후 수정 불가, 시그널 패널티 없음 |
| **HackerOne** | Web2+3 | `hackerone_submission_form.md` | CWE + CVSS 3.1 | 제출 후 수정 가능, N/A = -5 signal |
| **Intigriti** | Web2 | *(아래 Quick Ref)* | CVSS 3.1 | EU 중심, 빠른 커뮤니케이션 |
| **FindTheGap** | Web2 | *(아래 Quick Ref)* | CVSS 3.1 | 스페인 기반, 한국어/영어, UUID 태그 |
| **PSIRT Direct** | 벤더 | *(아래 Quick Ref)* | CVE 연동 | 이메일 기반, 긴 응답시간 |

Auto-detect: `tools/platforms.json`에서 URL 패턴으로 플랫폼 자동 감지
